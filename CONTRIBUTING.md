...
1. [Fork](https://github.com/quic/mkosi-qcom/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/mkosi-qcom.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/quic/mkosi-qcom.git
    ```
...
1. [Submit a pull request](https://github.com/quic/mkosi-qcom/pulls) from your branch to `main`.
